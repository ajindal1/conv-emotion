...
from model import PcoriEmotionModel, MaskedNLLLoss
from dataloader import PcoriEmotionPadCollate, PcoriEmotionDataset
from sklearn.metrics import f1_score, confusion_matrix, accuracy_score, classification_report, precision_recall_fscore_support


def get_PcoriEmotion_loaders(path, batch_size=32, num_workers=0, pin_memory=False):
    
    trainset = PcoriEmotionDataset('train', path)
    testset = PcoriEmotionDataset('test', path)
    validset = PcoriEmotionDataset('valid', path)

    train_loader = DataLoader(trainset,
                              batch_size=batch_size,
                              collate_fn = PcoriEmotionPadCollate(dim=0),
...
if __name__ == '__main__':
    ...
    train_loader, valid_loader, test_loader = get_PcoriEmotion_loaders('pcori/pcori_data.pkl',
